...
from django.contrib import messages
from django.urls import reverse_lazy
from .forms import AssignRoleForm, CreateGroupForm, EditProfileForm  
...
#  Assign Role
class AssignRoleView(LoginRequiredMixin, AdminRequiredMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f"User {self.user_obj.username} has been assigned to the {role.name} role")
        return redirect('admin-dashboard')
